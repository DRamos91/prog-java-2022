...
public class FormTesteEventos extends JFrame {
	...
	public FormTesteEventos() {
		...
		JMenuItem mntmListaAlfabetica = new JMenuItem("Listar em Ordem Alfab\u00E9tica");
		...
		mnClientes.addActionListener(evtClk);
		mnClientes.addFocusListener(evtFoc);
		...
		panelDiversos.add(passwordField);
