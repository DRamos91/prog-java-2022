...
public class FormularioTeste extends JFrame {
	...
	private JMenuItem mniCadastrar, mniConsultar, mniAlterar, mniExcluir, mniListar;
	...
	protected void criarComponentes() {
		...
		textNome = new JTextField("Digite aqui o nome");
		labelEndereco = new JLabel("Endereço do paciente");
		textEndereco = new JTextField("Digite aqui o endereço");
		btnOlaMundo = new JButton ("Clique aqui!");
		btnOlaClasse = new JButton("Clique aqui Classe!");
	...
	public void exibirFormAbsoluto() {
		...
		labelNome.setBounds(10, 10, 130, 25);
		textNome.setBounds(120, 10, 200, 25);
	...
	class EventoPadrao implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(e.getSource()==btnOlaMundo) {
				...
				JOptionPane.showMessageDialog(null, "Ola classe!");
			}
		}
